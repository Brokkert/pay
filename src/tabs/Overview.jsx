  ...
  return (
    <>
      ...
      {/* The two numbers it is all about: what runs in total, and how much of
          that is ultimately yours. */}
      <div className="panel">
        <div className="box roomy">
          <div className="row" style={{ alignItems: 'flex-start' }}>
            <div className="grow">
              <div className="section" style={{ margin: '0 0 6px' }}>Loopt deze maand</div>
              <Money cents={result.monthlyTotal} size="hero" />
            ...
            {me && (
              <div style={{ textAlign: 'right' }}>
                <div className="section" style={{ margin: '0 0 6px' }}>Jouw deel</div>
                <Money cents={result.borne[me.id] || 0} size="mid" />
              </div>
            )}
          </div>
        </div>
        {business > 0 && (
          <Line what="Waarvan zakelijk geboekt" sub="telt apart voor je boekhouding" cents={business} />
        )}
      </div>
