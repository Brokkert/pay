...
export function exampleHousehold() {
  ...
  const expenses = [
    { name: 'Energie', amount: 9000, category: 'utilities',
      payer: { kind: 'account', id: bills }, split: together },
    { name: 'Water', amount: 1500, category: 'utilities',
      payer: { kind: 'account', id: bills }, split: together },

    // Two expenses on a single charge from the same insurer.
    { name: 'Inboedel', amount: 1200, category: 'insurance', charge: 'Verzekeringen',
      payer: { kind: 'account', id: bills }, split: together },
    { name: 'Aansprakelijkheid', amount: 800, category: 'insurance', charge: 'Verzekeringen',
      payer: { kind: 'account', id: bills }, split: together },

    { name: 'Gemeentelijke heffingen', amount: 9000, cadence: 'quarter', category: 'tax',
      payer: { kind: 'account', id: bills }, split: together },
    ...
    { name: 'Streamingdienst', amount: 2000, category: 'media',
    ...
    { name: 'Muziekdienst', amount: 1200, category: 'media',
